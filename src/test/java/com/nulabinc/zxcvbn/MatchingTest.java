...
{
    private static void assertMatches(String prefix, Pattern expectedPattern, ExpectedMatch[] expectedMatches,
                                      List<Match> actualMatches)
    {
    ...
    public static class DictionaryMatching
    {
        ...
        private Map<String, Map<String, Integer>> dictionaries = new HashMap<String, Map<String, Integer>>();
    ...
    public static class RepeatMatchingSimple
    {
        ...
        public static Collection<Object[]> data()
        {
            return Arrays.asList(new Object[][]
            {
                ...
                {
                    "abababababbbbbbbbbbbb",
                    2
                },
                {
                    "abababababbbbbbbbbbb",
                    2
                }
    ...
    public static class RepeatMatching
    {
        ...
        public void testRepeatMatching() throws Exception
        {
            ...
            assertMatches("matches embedded repeat patterns", Pattern.Repeat, new ExpectedMatch[]
                  {
                      expectedMatch
            }, actualMatches);
        }
        ...
        public static Collection<Object[]> data()
        {
            ...
            for (String prefix : prefixes)
            {
                for (String suffix : suffices)
                {
                    ...
                    {
                        password,
                        new ExpectedMatch(pattern, i, j).baseToken("&")
                    });
                }
            }
            return result;
    ...
    public static class DateMatching
    {
        ...
        public void testDateMatching() throws Exception
        {
            ...
            assertMatches(message, Pattern.Date, new ExpectedMatch[]
                  {
                      expectedMatch
            }, actualMatches);
        }
    ...
    public static class RestMatching
    {
        ...
        {
            ReverseDictionaryMatcher reverseDictionaryMatcher = new ReverseDictionaryMatcher(
        ...
        private void testRegexMatching(String year) throws Exception
        {
            ...
            assertMatches(
                    ...
                    new ExpectedMatch[]
                    {
                        new ExpectedMatch(year).regexName("recent_year")
                    },
                    actualMatches);
        }
        ...
        public void testOmnimatch() throws Exception
        {
            ...
            Map<Pattern, Integer[]> testMatches = new HashMap<Pattern, Integer[]>();
            testMatches.put(Pattern.Dictionary, new Integer[]
                    {
                        0,
                        6
            });
            ...
            testMatches.put(Pattern.Date, new Integer[]
                    {
                        16,
                        23
            });
            testMatches.put(Pattern.Repeat, new Integer[]
                    {
                        24,
                        27
            });
            for (Map.Entry<Pattern, Integer[]> testMatch : testMatches.entrySet())
            {
                ...
                String msg = String.
                        format("for %s, matches a %s token at [%s, %s]", password, patternName.value(), i, j);
