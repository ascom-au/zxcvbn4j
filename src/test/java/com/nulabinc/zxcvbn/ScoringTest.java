    ...
    public static class UppercaseVariantsTest {
        ...
        public static Collection<Object[]> data() throws Exception {
            ...
            return Arrays.asList(new Object[][]{
                    ...
                    {"ABCDEf", method.invoke(baseGuess, 6, 1)},
                    {"aBCDEf", (Integer) method.invoke(baseGuess, 6, 1) + (Integer) method.invoke(baseGuess, 6, 2)},
                    {"ABCdef", (Integer) method.invoke(baseGuess, 6, 1) + (Integer) method.invoke(baseGuess, 6, 2) + (Integer) method.invoke(baseGuess, 6, 3)},
            });
        }
    }
    ...
    public static class L33tVariantsTest {
        ...
        public static Collection<Object[]> data() throws Exception {
            ...
            return Arrays.asList(new Object[][]{
                    ...
                    {"a4a4aa", (Integer) method.invoke(baseGuess, 6, 2) + (Integer) method.invoke(baseGuess, 6, 1), Collections.singletonMap('4', 'a')},
                    {"4a4a44", (Integer) method.invoke(baseGuess, 6, 2) + (Integer) method.invoke(baseGuess, 6, 1), Collections.singletonMap('4', 'a')},
                    {"a44att+", ((Integer) method.invoke(baseGuess, 4, 2) + (Integer) method.invoke(baseGuess, 4, 1)) * (Integer) method.invoke(baseGuess, 3, 1),
                            new HashMap<Character, Character>() {{
                                put('4', 'a');
                                put('+', 't');
                            }}},
                    {"Aa44aA", (Integer) method.invoke(baseGuess, 6, 2) + (Integer) method.invoke(baseGuess, 6, 1), Collections.singletonMap('4', 'a')}
            });
        }
    }
