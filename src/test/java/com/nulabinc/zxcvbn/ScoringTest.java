...
public class ScoringTest
{
    ...
    public static class DictionaryGuessesTest
    {
        ...
        public void testDictionaryGuessesCapitalization() throws Exception
        {
            ...
            assertEquals(msg, 32 * new DictionaryGuess().uppercaseVariations(match), new DictionaryGuess().exec(match),
                         0.0);
        }
        ...
        public void testDictionaryGuessesMixed() throws Exception
        {
            ...
            int expected = 32 * new DictionaryGuess().l33tVariations(match) * new DictionaryGuess().uppercaseVariations(
                    match);
    ...
    public static class UppercaseVariantsTest
    {
        ...
        public void testUppercaseVariants() throws Exception
        {
            ...
            Method uppercaseVariationsMethod = DictionaryGuess.class.getDeclaredMethod("uppercaseVariations",
                                                                                       Match.class);
            uppercaseVariationsMethod.setAccessible(true);

            Match match = new Match.Builder(Pattern.Dictionary, 0, 0, word).sub(new HashMap<Character, Character>()).
                    l33t(true).build();
        ...
        public static Collection<Object[]> data() throws Exception
        {
            ...
            return Arrays.asList(new Object[][]
            {
                ...
                {
                    "aBcDef", (Integer) method.invoke(baseGuess, 6, 1) + (Integer) method.invoke(baseGuess, 6, 2)
                },
                {
                    "ABCDEf", method.invoke(baseGuess, 6, 1)
                },
                ...
                {
                    "ABCdef",
                    (Integer) method.invoke(baseGuess, 6, 1) + (Integer) method.invoke(baseGuess, 6, 2) + (Integer) method.
                    invoke(baseGuess, 6, 3)
                },
            });
        }
    }
    ...
    public static class L33tVariantsTest
    {
        ...
        public static Collection<Object[]> data() throws Exception
        {
            ...
            return Arrays.asList(new Object[][]
            {
                ...
                {
                    "a4a4aa",
                    (Integer) method.invoke(baseGuess, 6, 2) + (Integer) method.invoke(baseGuess, 6, 1),
                    Collections.singletonMap('4', 'a')
                },
                {
                    "4a4a44",
                ...
                {
                    "a44att+",
                    ((Integer) method.invoke(baseGuess, 4, 2) + (Integer) method.invoke(baseGuess, 4, 1)) * (Integer) method.invoke(
                    baseGuess, 3, 1),
                    new HashMap<Character, Character>()
                    {
                        {
