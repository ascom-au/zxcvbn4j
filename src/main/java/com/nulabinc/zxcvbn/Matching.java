...
public class Matching {
    ...
    public Matching(Context context, List<String> orderedList) {
        ...
        final Map<String, Dictionary> dictionaryMap = new LinkedHashMap<String, Dictionary>(context.getDictionaryMap());
    ...
    private static Map<String, Map<String, Integer>> buildRankedDictionaryMap(Map<String, Dictionary> dictionaryMap) {
        Map<String, Map<String, Integer>> rankedDictionaries = new HashMap<String, Map<String, Integer>>();
